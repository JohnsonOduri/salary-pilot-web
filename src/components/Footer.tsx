          ...
          <div className="flex justify-center items-center">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center text-sm text-background/60">
                ...
                <a href="mailto:oduri.johnson@gmail.com" className="hover:text-background transition-colors">
              ...
              <div className="flex items-center text-sm text-background/60">
                ...
                <a href="https://github.com/johnsonoduri" className="hover:text-background transition-colors">
                  GitHub
                </a>
              </div>
            </div>
